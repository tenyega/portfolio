...
export default function Contact() {
    ...
    return (
        <main>
            <Nav />
            <h1>Contact</h1>
        <form className="pb-10 mx-auto min-w-1/3" action="https://api.web3forms.com/submit" method="POST">
                                ...
                                <div className="mt-2">
                                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        <input
                                            ...
                                            className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-slate-200 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                            placeholder="Smith"
                                        />
                                    </div>
                                </div>
